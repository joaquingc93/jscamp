...
export function HomePage() {
  ...
  const handleSearch = (event) => {
    ...
    const url = searchTerm ? `/search?query=${encodeURIComponent(searchTerm)}` : '/search';
    navigateTo(url);
  }
  ...
  return (
    <main>
      <section>
        <img src="./background.webp" width="200" alt="Background" />
        ...
        <form role="search" onSubmit={handleSearch}>
          <div>
            ...
            <button disabled={true} type="submit">Buscar</button>
          </div>
        </form>
      </section>
